    ...
    <nav class="bottom-navbar-sticky-apply"> 
        <div class="bottom-navbar-home">
            <ul class="bottom-navbar-list">
                ...
                <li class="bottom-navbar-list-items">
                    <a class="nav-link px-2" href="view_advertisements.php"><i class="bi bi-megaphone bi-icon-color"></i> Our Connections</a>           
                </li>
            ...
            <div class="row">
                ...
                <form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method = "GET">
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-primary px-4 py-3 my-3" type="submit" id="button-addon2" style="background-color: #724a0d;border:#724a0d" ><i class="bi bi-search"></i></button>
                    </div>
                </form>
