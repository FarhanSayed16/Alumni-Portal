    ...
    <nav class="bottom-navbar-sticky-apply">
        <div class="bottom-navbar-view">
            <ul class="bottom-navbar-list">
                ...
                <li class="bottom-navbar-list-items">
                    <a class="nav-link nav-main-active px-2" href="view_advertisements.php"><i class="bi bi-megaphone bi-icon-color"></i> Advertisement</a>           
                </li>
                <li class="bottom-navbar-list-items">
                                    ...
                                    <?php if ($advertisement['appliable'] == 1) { ?>
                                        <div class="mb-4">
                                            <form action="<?php echo htmlspecialchars('advertisement_apply.php');?>" method="GET">
                                                ...
                                                <button type='submit' class='btn btn-primary fw-medium py-2 px-5' style="background-color: #724a0d;border:#724a0d">Apply</button>
                                            </form>
                                        </div>
                                    <?php } ?>
                                </div>
