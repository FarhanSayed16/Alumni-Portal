            ...
            <div class="row align-items-center">
                <div class="col ms-4 slide-left">
                    ...
                    <div class="row justify-content-center mt-5">
                        <!-- Login button -->
                        <div class="col-auto">
                            <a role="button" href="login.php" class="btn btn-primary fw-medium px-4 py-2" style="background-color: #724a0d;border:2px solid #724a0d">Login</a>
                        </div>
                        <!-- Register button -->
                        <div class="col-auto">
                            <a role="button" href="registration.php" class="btn btn-outline-primary fw-medium px-4 py-2" style="border:2px solid #724a0d;color:#724a0d">Register</a>
                        </div>
                    </div>
                </div>
